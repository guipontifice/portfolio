 ...
 */
var l$4 = Symbol.for("react.element"), n$3 = Symbol.for("react.portal"), p$3 = Symbol.for("react.fragment"), q$1 = Symbol.for("react.strict_mode"), r$2 = Symbol.for("react.profiler"), t$3 = Symbol.for("react.provider"), u$3 = Symbol.for("react.context"), v$2 = Symbol.for("react.forward_ref"), w$3 = Symbol.for("react.suspense"), x$1 = Symbol.for("react.memo"), y$2 = Symbol.for("react.lazy"), z$1 = Symbol.iterator;
function A$1(a2) {
...
function R$2(a2, b2, e2, d2, c2) {
  ...
  if (h2)
    return h2 = a2, c2 = c2(h2), a2 = "" === d2 ? "." + Q$1(h2, 0) : d2, I$3(c2) ? (e2 = "", null != a2 && (e2 = a2.replace(P$1, "$&/") + "/"), R$2(c2, b2, e2, "", function(a3) {
      return a3;
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$3 = reactExports, k = Symbol.for("react.element"), l$3 = Symbol.for("react.fragment"), m$1 = Object.prototype.hasOwnProperty, n$2 = f$3.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$2 = { key: true, ref: true, __self: true, __source: true };
function q(c2, a2, g2) {
...
var ce = ia && "TextEvent" in window && !be$2, de$1 = ia && (!ae$1 || be$2 && 8 < be$2 && 11 >= be$2), ee = String.fromCharCode(32), fe$1 = false;
function ge$1(a2, b2) {
  switch (a2) {
    case "keyup":
...
function ke(a2, b2) {
  if (ie)
    return "compositionend" === a2 || !ae$1 && ge$1(a2, b2) ? (a2 = nd(), md = ld = kd = null, ie = false, a2) : null;
  switch (a2) {
    case "paste":
      return null;
    case "keypress":
    ...
    case 13:
      ...
      if (null !== d2) {
        if (null !== d2.dehydrated)
          return G(M$3, M$3.current & 1), b2.flags |= 128, null;
...
function Fj(a2, b2, c2) {
  ...
  switch (b2.tag) {
    ...
    case 13:
      ...
      d2 = null !== d2;
      d2 !== (null !== a2 && null !== a2.memoizedState) && d2 && (b2.child.flags |= 8192, 0 !== (b2.mode & 1) && (null === a2 || 0 !== (M$3.current & 1) ? 0 === T$1 && (T$1 = 3) : uj()));
    ...
    case 19:
      ...
      if (null !== f2.tail)
        return b2 = f2.tail, f2.rendering = b2, f2.tail = b2.sibling, f2.renderingStartTime = B(), b2.sibling = null, c2 = M$3.current, G(M$3, d2 ? c2 & 1 | 2 : c2 & 1), b2;
      S$3(b2);
      return null;
    case 22:
    case 23:
...
function mh(a2, b2, c2, d2) {
  ...
  Ac(a2, c2, d2);
  if (0 === (K & 2) || a2 !== R$1)
    a2 === R$1 && (0 === (K & 2) && (rk |= c2), 4 === T$1 && Dk(a2, Z)), Ek(a2, d2), 1 === c2 && 0 === K && 0 === (b2.mode & 1) && (Hj = B() + 500, fg && jg());
}
function Ek(a2, b2) {
  var c2 = a2.callbackNode;
  wc(a2, b2);
  var d2 = uc(a2, a2 === R$1 ? Z : 0);
  if (0 === d2)
...
function Ui(a2, b2, c2) {
  ...
  R$1 === a2 && (Z & c2) === c2 && (4 === T$1 || 3 === T$1 && (Z & 130023424) === Z && 500 > B() - gk ? Lk(a2, 0) : sk |= c2);
  Ek(a2, b2);
}
function Zk(a2, b2) {
...
function F({ container: e$12, accept: t2, walk: r2, enabled: c2 = true }) {
  ...
  reactExports.useEffect(() => {
    ...
    if (!n2)
      return;
    let f2 = o3.current, p2 = l2.current, d2 = Object.assign((i2) => f2(i2), { acceptNode: f2 }), u2 = n2.createTreeWalker(e$12, NodeFilter.SHOW_ELEMENT, d2, false);
    for (; u2.nextNode(); )
      p2(u2.currentNode);
  }, [e$12, c2, o3, l2]);
}
...
`)].join(`
`));
    let i2 = l2.props, m2 = typeof (i2 == null ? void 0 : i2.className) == "function" ? (...d2) => t$1(i2 == null ? void 0 : i2.className(...d2), o3.className) : t$1(i2 == null ? void 0 : i2.className, o3.className), y2 = m2 ? { className: m2 } : {};
    return reactExports.cloneElement(l2, Object.assign({}, N(l2.props, R(g$2(o3, ["ref"]))), p2, u2, w$1(l2.ref, u2.ref), y2));
  }
...
function Me(e2, u2) {
  let { __demoMode: r2 = false, ...i2 } = e2, s2 = reactExports.useReducer(ye$1, { __demoMode: r2, menuState: r2 ? 0 : 1, buttonRef: reactExports.createRef(), itemsRef: reactExports.createRef(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: t2, itemsRef: o3, buttonRef: a2 }, l2] = s2, m2 = y(u2);
  h([a2, o3], (g2, R2) => {
    var p2;
...
function Re$1(e2, u2) {
  var R2;
  let r$12 = I$1(), { id: i2 = `headlessui-menu-button-${r$12}`, ...s$12 } = e2, [t2, o3] = O("Menu.Button"), a2 = y(t2.buttonRef, u2), l2 = p(), m2 = o$3((p2) => {
    switch (p2.key) {
      case o$1.Space:
      case o$1.Enter:
      case o$1.ArrowDown:
        p2.preventDefault(), p2.stopPropagation(), o3({ type: 0 }), l2.nextFrame(() => o3({ type: 2, focus: a$1.First }));
        break;
      case o$1.ArrowUp:
        p2.preventDefault(), p2.stopPropagation(), o3({ type: 0 }), l2.nextFrame(() => o3({ type: 2, focus: a$1.Last }));
        break;
    }
  }), I2 = o$3((p2) => {
    switch (p2.key) {
...
function Ee(e2, u2) {
  var M2, b2;
  let r2 = I$1(), { id: i2 = `headlessui-menu-items-${r2}`, ...s2 } = e2, [t2, o3] = O("Menu.Items"), a2 = y(t2.itemsRef, u2), l2 = n(t2.itemsRef), m2 = p(), I2 = C(), A2 = (() => I2 !== null ? (I2 & d.Open) === d.Open : t2.menuState === 0)();
  reactExports.useEffect(() => {
  ...
  let f2 = o$3((n2) => {
    ...
    switch (m2.dispose(), n2.key) {
      ...
      case o$1.Enter:
        ...
        break;
      case o$1.ArrowDown:
        return n2.preventDefault(), n2.stopPropagation(), o3({ type: 2, focus: a$1.Next });
      case o$1.ArrowUp:
        return n2.preventDefault(), n2.stopPropagation(), o3({ type: 2, focus: a$1.Previous });
      case o$1.Home:
      case o$1.PageUp:
        return n2.preventDefault(), n2.stopPropagation(), o3({ type: 2, focus: a$1.First });
      case o$1.End:
      case o$1.PageDown:
        return n2.preventDefault(), n2.stopPropagation(), o3({ type: 2, focus: a$1.Last });
      case o$1.Escape:
...
function Pe$1(e2, u$12) {
  let r2 = I$1(), { id: i2 = `headlessui-menu-item-${r2}`, disabled: s2 = false, ...t2 } = e2, [o3, a2] = O("Menu.Item"), l2 = o3.activeItemIndex !== null ? o3.items[o3.activeItemIndex].id === i2 : false, m2 = reactExports.useRef(null), I2 = y(u$12, m2);
  l$2(() => {
...
function LanguageSelector2() {
  const currentLanguageCode = api.get("i18next") || "en";
  const currentLanguage = languages.find((lang) => lang.code === currentLanguageCode);
  reactExports.useEffect(() => {
    document.body.dir = currentLanguage.dir || "ltr";
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dropdown", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(it, { as: "div", className: "relative inline-block text-left w-35 bg-zinc900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(it.Button, { className: "bg-zinc800 inline-flex w-full justify-center gap-x-1.5 rounded-md px-5 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "w-5 mx-0 text-white bg-zinc800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418" }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      tt,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "bg-zinc900 dropwdown-menu text-white", "aria-labelledby": "dropdownMenuButton1", children: languages.map(({ code, name, country_code }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "hover:bg-sky-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            className: "dropdown-item bg-zinc900",
            onClick: () => instance.changeLanguage(code),
            disabled: code === currentLanguageCode,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `flag-icon flag-icon-${country_code} w-5 font-nunito text-gray text-xs hover:text-white items-center mx-1` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 font-nunito text-gray text-xs hover:text-white items-center mx-2", children: name })
            ]
          }
        ) }, country_code)) })
      }
...
function Navbar() {
  ...
  const [showDarkMode, setDarkMode] = reactExports.useState(false);
  const handleLinkClick = (link) => {
    setShowSidebar(false);
  };
  const Links = [
    { name: t2("home"), link: "/portfolio" },
    { name: t2("about_me"), link: "/AboutMe" },
    { name: t2("projects"), link: "/Projects" },
    { name: t2("contact"), link: "/Contact" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 bg-zinc900 w-full md:hidden h-10 lg:hidden xl:hidden 2xl:hidden absolute fixed w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-5 my-3 md:hidden lg:hidden xl:hidden 2xl:hidden flex flex-row justify-between bg-zinc900", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageSelector2, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          id: "menuButton",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("ion-icon", { name: showSidebar ? "close" : "menu", className: "absolute fixed z-50" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: `font-roboto text-white font-medium flex flex-col justify-around fixed top-0 right-0 w-0 transition-all duration-300 ease-in-out overflow-hidden bg-zinc900 ${showSidebar ? "w-screen h-screen" : "w-0"} z-10`, children: showSidebar ? Links.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { onClick: () => handleLinkClick(link.link), to: link.link, className: `items-center text-xl flex justify-around`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `flex flex-column m-5 duration-400`, children: link.name }) }, link.name)) : null })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "xxs:hidden xs:hidden sm:hidden flex flex-row justify-between w-8/12 mt-4 fixed md:flex-wrap-reverse absolute fixed", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageSelector2, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 mx-10 border-x-2 ring-1 ring-white rounded-full border-[#e5e7eb] bg-zinc800 font-bold text-gray", children: Links.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: link.link, className: "flex-row items-center mt-2 mb-2 justify-center text-xs hover:text-white font-roboto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-5", children: link.name }) }, link.name)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick: () => setDarkMode(!showDarkMode), className: "flex h-10 text-xl cursor-pointer rounded-md bg-zinc800 font-bold text-gray w-11 ring-1 ring-inset ring-gray-300 justify-center items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          id: "menuButton",
          type: "button",
          ...
          "aria-label": "Menu",
          "aria-expanded": "true",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("ion-icon", { name: showDarkMode ? "sunny-outline" : "moon-outline", className: "absolute fixed z-50" })
        }
      ) })
    ] })
  ] });
...
var Backend = function() {
  ...
  _createClass(Backend2, [{
    ...
    key: "create",
    value: function create2(languages2, namespace, key, fallbackValue, callback) {
      var _this4 = this;
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(Router, { basename: "/portfolio", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: loadingMarkup, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) }) })
);
