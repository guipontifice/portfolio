...
import authPhoto from '../../public/assets/images/authPhoto.png'
function Projects({ id }) {
  const { t } = useTranslation()
  const Projects = [
    {
      title: 'Auth',
      paragraph: 'Autenticação de usuário com Login e Senha, além de autenticação em dois fatores e redefinição de senha',
      githubLink: 'https://github.com/guipontifice/authentication',
      webLink: 'https://authentication-cyan-theta.vercel.app/',
      image: authPhoto,
      technologies: ['Online', 'React', 'TypeScript', 'NextJS', 'Styled Components', 'Prisma','TailwindCSS']
    },
{
  title: 'Movie Catalog',
