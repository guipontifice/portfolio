...
function Works({ id }) {
    return (
        <>
            {/* Desktop */}
            <div id={id} className='w-10/12 flex flex-col items-center justify-center xxs:hidden xs:hidden sm:hidden md:hidden'>
                <div className='xxs:hidden xs:hidden sm:hidden md:hidden font-roboto w-2/12 mb-10 '>
                ...
                <div className='flex flex-col justify-center items-center align-middle mt-10 font-roboto w-10/12 text-green'>
                    <h1 className='text-5xl text-white font-bold mb-10'>Trajetória até aqui</h1>
            ...
            <div className='lg:hidden xl:hidden 2xl:hidden 3xl:hidden 4xl:hidden border-t border-purple w-10/12 mt-10 border-opacity-20'>
                <div className='flex flex-col items-center'>
                    <div className='flex flex-row items-center justify-center py-4 w-24 h-10 text-purple bg-purple bg-opacity-20 rounded-lg font-semibold mt-10'>
                        <h2 className='mr-2'>💼 Carreira</h2>
                    </div>
                    <div className='flex flex-col justify-center items-center align-middle mt-10 font-roboto  text-green'>
                        <h1 className='text-5xl text-white font-bold mb-10'>Trajetória até aqui</h1>
                        <div className='mt-10 border border-green bg-green bg-opacity-20 rounded-xl w-4/6 p-8 hover:bg-opacity-10 hover:border-0'>
                            <h1 className='text-white text-xl font-semibold'>
                                Desenvolvedor Front-end
                            </h1>
                            <p className='text-white text-opacity-60 text-md mt-4 mb-4'>Como engenheiro de software, meu foco é criar e manter sistemas eficientes,
                        ...
                        <div className='mt-10 border border-purple bg-opacity-20 rounded-xl w-4/6 p-8 hover:bg-purple hover:bg-opacity-10 hover:border-0'>
                            <h1 className='text-white text-xl font-semibold'>
                                Auxiliar de Pricing
                            </h1>
                            <p className='text-white text-opacity-60 text-md mt-4 mb-4'>Como Auxiliar de Pricing, a minha responsabilidade era criar preços condizentes com as características das empresas e com a nossa estratégia.
